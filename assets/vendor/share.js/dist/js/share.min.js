!function (r) {
    ...
    function o(r, t, e) {
        var n = e.size, o = e.image.naturalWidth || 1, i = e.image.naturalHeight || 1, a = e.mSize, u = a * o / i,
            f = (1 - u) * e.mPosX, c = (1 - a) * e.mPosY, l = f + u, s = c + a, d = .01;
    ...
    function c(r, t, e, n, o, i, a, c) {
        var l = r.isDark, s = n + i, d = o + i, h = e.radius * i, g = a - 1, v = a + 1, w = c - 1, p = c + 1,
            m = l(a, c), T = l(g, w), y = l(g, c), E = l(g, p), A = l(a, p), B = l(v, p), k = l(v, c), C = l(v, w),
            M = l(a, w);
    ...
    function l(r, t, e) {
        ...
        for (m && e.radius > 0 && e.radius <= .5 && (f = c), t.beginPath(), n = 0; i > n; n += 1) for (o = 0; i > o; o += 1) {
            var l = e.left + o * u, s = e.top + n * u, d = u;
            f(r, t, e, l, s, d, n, o)
        }
        if (w(e.fill).is("img")) {
    ...
    function g(r) {
        ...
        var n, o, i = r.size, a = r.background, u = Math.floor, f = t.moduleCount, c = u(i / f),
            l = u(.5 * (i - c * f)),
            s = {position: "relative", left: 0, top: 0, padding: 0, margin: 0, width: i, height: i},
            d = {position: "absolute", padding: 0, margin: 0, width: c, height: c, "background-color": r.fill},
            h = w("<div/>").data("qrcode", t).css(s);
        for (a && h.css("background-color", a), n = 0; f > n; n += 1) for (o = 0; f > o; o += 1) t.isDark(n, o) && w("<div/>").css(d).css({
            left: l + o * c,
            top: l + n * c
        }).appendTo(h);
        return h
    ...
    var r = function () {
        ...
        var t = function (t, e) {
            var o = 236, a = 17, l = t, s = n[e], d = null, h = 0, v = null, w = new Array, p = {},
                m = function (r, t) {
                    ...
                    for (var e = -1; 7 >= e; e += 1) if (!(-1 >= r + e || r + e >= h)) for (var n = -1; 7 >= n; n += 1) -1 >= t + n || t + n >= h || (e >= 0 && 6 >= e && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) || e >= 2 && 4 >= e && n >= 2 && 4 >= n ? d[r + e][t + n] = !0 : d[r + e][t + n] = !1)
                }, y = function () {
                    ...
                    for (var r = i.getPatternPosition(l), t = 0; t < r.length; t += 1) for (var e = 0; e < r.length; e += 1) {
                        var n = r[t], o = r[e];
                        if (null == d[n][o]) for (var a = -2; 2 >= a; a += 1) for (var u = -2; 2 >= u; u += 1) -2 == a || 2 == a || -2 == u || 2 == u || 0 == a && 0 == u ? d[n + a][o + u] = !0 : d[n + a][o + u] = !1
                    }
                }, B = function (r) {
                    ...
                    for (var e = -1, n = h - 1, o = 7, a = 0, u = i.getMaskFunction(t), f = h - 1; f > 0; f -= 2) for (6 == f && (f -= 1); ;) {
                        for (var c = 0; 2 > c; c += 1) if (null == d[n][f - c]) {
                            var l = !1;
                    ...
                    for (var n = 0, o = 0, a = 0, u = new Array(e.length), f = new Array(e.length), c = 0; c < e.length; c += 1) {
                        ...
                        n += l;
                        var h = i.getErrorCorrectPolynomial(s), g = r(u[c], h.getLength() - 1), v = g.mod(h);
                    ...
                    for (var m = new Array(p), T = 0, d = 0; o > d; d += 1) for (var c = 0; c < e.length; c += 1) d < u[c].length && (m[T] = u[c][d], T += 1);
                    for (var d = 0; a > d; d += 1) for (var c = 0; c < e.length; c += 1) d < f[c].length && (m[T] = f[c][d], T += 1);
                    return m
                }, b = function (r, t, e) {
            ...
            return p.addData = function (r) {
                ...
                r = r || 2, t = "undefined" == typeof t ? 4 * r : t;
                var e = p.getModuleCount() * r + 2 * t, n = t, o = e - t;
        ...
        var e = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, n = {L: 1, M: 0, Q: 3, H: 2},
            o = {
                ...
                var a = function (r) {
                    ...
                    var c = l(), s = a(c);
                    s.write(t, n);
                    var d = 0, h = String.fromCharCode(o[d]);
                    for (d += 1; d < o.length;) {
    ...
    r.fn.share = function (t, e) {
        ...
        var u = r(document).find("img:first").prop("src"), f = {
        ...
        this.each(function () {
            var t = r.extend({}, c, r(this).data() || {}), e = r(this).addClass("share-component");
            n(e, t), o(e, t)
        })
